...
import 'package:challenge003/home/panelDown.dart';
import 'package:challenge003/home/panelUp.dart';
...
class _ScreenHomeState extends State<ScreenHome> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    _percentage = Tween<double>(begin: 0.0, end: 0.0).animate(_animationController);
  }
  ...
  _onCameraModeTap(CameraMode cameraMode) {
    ...
    _animateDown(duration: Duration(milliseconds: 300));
  }
        ...
        onVerticalDragEnd: (_) {
          if (_.velocity.pixelsPerSecond.dy.abs() < 2) {
            if (_percentage.value > 0.5) {
              _animateUp(duration: Duration(milliseconds: 300));
            } else {
              _animateDown(duration: Duration(milliseconds: 300));
            }
            return;
                ...
                child: AnimatedBuilder(
                  ...
                  builder: (_, Widget child) {
                    return Transform.translate(
                      offset: Offset(0, -_panelBottomHeight * _percentage.value),
                      child: Transform(
                        transform: Matrix4.identity()
                          ..setEntry(3, 2, 0.001)
                          ..rotateX(-pi / 2 * _percentage.value),
